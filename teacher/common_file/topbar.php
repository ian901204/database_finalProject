...
<div class="sidebar">
    <menu>
        ...
        <a href="javascript:void(0)" id = "menu_1_1" class = "menu-option child" onclick = "openNav('add_apartment')" style = "display:none;">新增科系</a>
    </menu>
    <menu>
        <a id = "menu_2" class = "menu-option" href = "teacher/course_manage.php">課程管理</a>
        <a href="javascript:void(0)" id = "menu_2_1" class = "menu-option child" onclick = "openNav('add_course')" style = "display:none;">新增課程</a>
    </menu>
    <menu>
